...
export default function UploadPage() {
  ...
  const analysis = await ai.parse(file);
          ...
          <Card className="glass-effect border-0 mx-auto max-w-md hover-glow">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <Upload className="h-12 w-12 text-[#E2E1E6]/60 mb-4" />
                  <input
                    type="file"
                    id="resume"
                    accept=".pdf,.doc,.docx"
                  ...
                  <label
                    htmlFor="resume"
                    className="cursor-pointer text-[#E2E1E6]/60 hover:text-[#E2E1E6] 
