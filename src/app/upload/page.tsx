      ...
      <div className="relative min-h-screen p-4 md:p-8">
        ...
        <div className="max-w-4xl mx-auto pt-12">
          ...
          <div className="text-center space-y-6 mb-16">
            <h1 className="text-6xl md:text-7xl font-bold tracking-tight text-gradient">Upload Resume</h1>
            <p className="text-[#E2E1E6]/60 text-xl">Let AI optimize your career path</p>
            {/* ✅ Display the selected model */}
            <p className="text-lg text-indigo-400">Selected Model: {selectedModel}</p>
          </div>

          {/* Upload Card */}
          <Card className="glass-effect border-0 mx-auto max-w-md hover-glow">
  <CardHeader>
    <CardTitle className="text-2xl text-center text-[#E2E1E6] ">Select Your File</CardTitle>
  </CardHeader>
  <CardContent>
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="flex flex-col items-center justify-center p-8 border-2 
        ...
        <label htmlFor="resume" className="cursor-pointer flex flex-col items-center text-center">
          ...
          <p className="text-sm text-[#E2E1E6]/40 mt-2">PDF, DOC, DOCX (max 10MB)</p>
        </label>
      </div>
    ...
    {message && (
      <p className={`mt-4 text-sm text-center ${message.includes("successfully") ? "text-green-400" : "text-red-400"}`}>
        {message}
      </p>
    )}
  </CardContent>
